...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_B] = LAYOUT_69_ansi(
        ...
        LT_MNAV, KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          M_LOCK,
        MT_CTES, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN,  KC_QUOT,            KC_ENT,           M_PRINT,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     MO(MAC_F),KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        M_LANG,  KC_LALT,  MT_GUBS,           MT_ALSP,          LT_DFUN,  MO(FUN),           MT_ALEN,           KC_LGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [MAC_N] = LAYOUT_69_ansi(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUI, RGB_SAI, RGB_SPI, KC_LEFT,           KC_DOWN, KC_UP,   KC_RGHT,  _______,  _______,  _______,          _______,
        _______,           RGB_RMOD, RGB_VAD, RGB_HUD, RGB_SAD, _______,  _______, KC_PGDN, KC_HOME, A_LEFT,   A_RIGHT,  KC_END,   _______, _______,
        _______, _______,  _______,           _______,          KC_DEL,   _______,          _______,           _______,            _______, KC_PGDN, _______),

    [MAC_F] = LAYOUT_69_ansi(
        MA_RES,  KC_BRID,  KC_BRIU, KC_MCTRL, KC_LNPAD,RGB_VAD, RGB_VAI,  KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,          RGB_TOG,
