...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PC_B] = LAYOUT_69_ansi(
        ...
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     MO(PC_F), KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LALT,  KC_LGUI,           KC_SPC,           KC_LALT,  MO(FUN),           KC_ENT,            KC_LGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
