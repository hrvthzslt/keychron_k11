...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     MO(PC_FN1), KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LALT,  MT_GUBS,           MT_ALSP,          LT_DFUN,  MO(FN2),          MT_ALEN,           KC_LGUI,            KC_LEFT, KC_DOWN, KC_RGHT),

    [PC_BASE] = LAYOUT_69_ansi(
        KC_GRV,  KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,     KC_7,     KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
        ...
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     MO(PC_FN1), KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LALT,  KC_LGUI,           KC_SPC,           KC_LALT,  MO(FN2),          KC_ENT,            KC_LGUI,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [MAC_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
        [PC_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
        [NAV]  = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
        [MAC_BASE]  = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
        [PC_FN1]  = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
